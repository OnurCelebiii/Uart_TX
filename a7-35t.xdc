...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { top_clk }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
...
## Buttons
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { top_i_rst}]; #IO_L6N_T0_VREF_16 Sch=btn[0]
set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { top_i_start_byte }]; #IO_L11P_T1_SRCC_16 Sch=btn[1]
...
## USB-UART Interface
set_property -dict { PACKAGE_PIN D10   IOSTANDARD LVCMOS33 } [get_ports { top_o_tx }]; #IO_L19N_T3_VREF_16 Sch=uart_rxd_out
